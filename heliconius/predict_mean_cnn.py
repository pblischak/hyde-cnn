...
if __name__ == '__main__':
    ...
    data = np.load('heliconius_mean_data.npz')
    xtest,ytest = data['xtest'],data['ytest']
    del data

    model = load_model('heliconius_cnn_mean.mdl')
    ...
    fig.tight_layout()
    plt.savefig("heliconius_cnn_mean_confusion-matrix.svg")
    plt.savefig("heliconius_cnn_mean_confusion-matrix.png")
    plt.show()
