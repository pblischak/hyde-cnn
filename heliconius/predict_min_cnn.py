...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Options for predict_min.py", add_help=True)
    ...
    model = load_model('heliconius_cnn_min.mdl')
    ...
    fig.tight_layout()
    plt.savefig("heliconius_cnn_min_confusion-matrix.svg")
    plt.savefig("heliconius_cnn_min_confusion-matrix.png")
    plt.show()
