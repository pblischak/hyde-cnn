...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Options for predict_mean_flagel.py", add_help=True)
    ...
    model = load_model('hyde_flagel_mean_{}.mdl'.format(cu))
    ...
    fig.tight_layout()
    plt.savefig("hyde_flagel_mean_confusion-matrix_{}.svg".format(cu))
    plt.savefig("hyde_flagel_mean_confusion-matrix_{}.png".format(cu))
    plt.show()
