...
if __name__ == '__main__':
    ...
    data = np.load('../processed_data/hyde_cnn_min-mean_data_{}.npz'.format(cu))
    xtest,ytest = data['xtest'],data['ytest']
    del data

    model = load_model('hyde_cnn_min-mean_{}.mdl'.format(cu))
    ...
    fig.tight_layout()
    plt.savefig("hyde_cnn_min-mean_confusion-matrix_{}.svg".format(cu))
    plt.savefig("hyde_cnn_min-mean_confusion-matrix_{}.png".format(cu))
    plt.show()
