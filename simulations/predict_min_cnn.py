...
if __name__ == '__main__':
    ...
    model = load_model('hyde_cnn_min_{}.mdl'.format(cu))
    ...
    fig.tight_layout()
    plt.savefig("hyde_cnn_min_confusion-matrix_{}.svg".format(cu))
    plt.savefig("hyde_cnn_min_confusion-matrix_{}.png".format(cu))
    plt.show()
