...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Options for predict_min_flagel.py", add_help=True)
    ...
    model = load_model('hyde_flagel_min_{}.mdl'.format(cu))
    ...
    fig.tight_layout()
    plt.savefig("hyde_flagel_min_confusion-matrix_{}.svg".format(cu))
    plt.savefig("hyde_flagel_min_confusion-matrix_{}.png".format(cu))
    plt.show()
