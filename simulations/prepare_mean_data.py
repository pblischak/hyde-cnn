...
if __name__ == '__main__':
    ...
    for cu in ['0.5', '1.0', '2.0']:
        ...
        np.savez_compressed(
            '../processed_data/hyde_cnn_mean_data_{}.npz'.format(cu),
